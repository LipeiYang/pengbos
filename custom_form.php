    ...
    class my_custom_fields {
        ...
        var $customFields = array(
            ...
            array(
                ...
                "description" => "You can put here your image or video links, the best size is 600x300 if it is put on featured section. ",
                "type" => "mytheme_upload",
                "scope" => array("post"),
                "capability" => "edit_post"
            ),
            array(
                ...
                "description" => "Write url of thumbnail image for the portfolio item. Usually, you have to provide multiple values for this key. The best size is 223x112",
                "type" => "mytheme_upload",
                "scope" => array("post"),
                "capability" => "edit_post"
            ),
            ...
            array(
                ...
                "title" => "Thumb Image for blog posts ",
                "type" => "mytheme_upload",
                "scope" => array("post"),
                "capability" => "edit_post"
            )
