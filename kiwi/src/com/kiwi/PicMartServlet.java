		...
		try {
			...
			if(cancel != null && cancel.equals("1")) {
				...
				try {
					...
					simplePay.setReceiver(primaryReceiver);
...
//				}
				...
				photo.setTitle("cherry blossoms");
				photo.setThumbUrl("http://pengbos.com/wp-content/uploads/2010/07/cherry-blossoms.jpg");
				photo.setUrl("http://pengbos.com/wp-content/uploads/2010/07/cherry-blossoms.jpg");
