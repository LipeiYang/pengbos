  ...
  public Object invoke(MethodInvocation methodInvocation) throws Throwable {
    ...
    if (methodInvocation.getMethod().getName().equals("handleRequest")) {
      ...
      UserService userService = (UserService) applicationContext.getBean(
    		  KiwiShopConstants.BEAN_USERSERVICE);
      DatastoreService dsService = (DatastoreService)
          applicationContext.getBean(KiwiShopConstants.BEAN_DSSERVICE);

      Entity audit = new Entity(KiwiShopConstants.AUDIT_ENTITY);
      if (userService.isUserLoggedIn()) {
        audit.setProperty(KiwiShopConstants.AUTH_USER,
