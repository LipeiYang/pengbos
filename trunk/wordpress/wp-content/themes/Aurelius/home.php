...
<div id="featured" class="clearfix grid_12">
    ...
    <div id="lastestblog" class="grid_12">    
        ...
        <a class="quicknavgrid_3 blog_item <?php echo $item_class; ?>" href="<?php the_permalink(); ?>" title="<?php the_title()?> more...">
                 ...
                 <?php endif; ?>
                <p style="text-align:center;color: #000000"> <?php the_title();?></p>
            </a>    
    ...
    <div id="quicknav" class="grid_12">    
        ...
        <a class="quicknavgrid_3 quicknav" href="<?php echo get_option('home'); ?>/about">
            ...
            <p style="text-align:center;"><img class="tooltipclass" alt="contact me please" src="<?php bloginfo('template_url'); ?>/images/info.png"/></p>
        ...
        <a class="quicknavgrid_3 quicknav" href="<?php echo get_option('home'); ?>/category/blog/">
            ...
            <p style="text-align:center;"><img class="tooltipclass" alt="blog" src="<?php bloginfo('template_url'); ?>/images/Blog_Artdesigner.lv.png" /></p>
        ...
        <a class="quicknavgrid_3 quicknav" href="<?php echo get_option('home'); ?>/contact-us">
            ...
            <p style="text-align:center;"><img alt="" class="downloadtooltip" src="<?php bloginfo('template_url'); ?>/images/hungry_bird.png" title="new "/></p>
        </a>    
    </div>    
    <div class="hr grid_12 clearfix">&nbsp;</div>    
