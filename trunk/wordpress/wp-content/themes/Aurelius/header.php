    ...
    <head>
        	...
        	<![endif]-->   
                  ...
                  <script>        
                        jQuery(document).ready(function($) {    
                           ...
                           $('img.downloadtooltip[title]').tooltip({
                                   events: {
                                        def: 'load, error'
                                    }
                              });  
        ...
        <body>        
            <div id="wrapper" class="container_12 clearfix">        
                <!-- Text Logo -->        
                <div id="logo" class="grid_4"><a href="<?php echo get_settings('home'); ?>"><img src="<?php bloginfo('template_url'); ?>/images/logo.small.gif" alt=""/></a></div>
